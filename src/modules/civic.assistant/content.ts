// Embedded hub documents for the drafting assistant.
//
...
// the content here.
//
// The Code of Conduct is hub-level and shared by every process type.
// Per-type best-practices documents live with their process handler
// (src/processes/*AssistantConfig.ts) — the handler declares them via
// the registry, the assistant never picks one itself.
