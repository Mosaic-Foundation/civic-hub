// The Settings page's older sections, until each moves into its own entry in
// the section list (step 6 of Phase 1 part five). Hub identity has already
// moved to IdentitySection and the settings endpoint.
